 ...
 * Use the [tutSecondFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class tutSecondFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment tutSecondFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            tutSecondFragment().apply {
